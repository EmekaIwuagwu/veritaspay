...
interface IVPayProcessor {
     ...
     */
    event BatchPaymentsExecuted(address indexed sender, uint256 recipientCount, uint256 totalAmount, string purpose);
     ...
     */
    function calculateMerchantFee(uint256 amount) external view returns (uint256 fee);
}
